...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/root/cnn/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/root/cnn/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/root/cnn/$(BIND_DIR)")
